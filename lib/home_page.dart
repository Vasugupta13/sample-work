...
class _HomepageState extends State<Homepage> {
  ...
  checkForSubStatus(String productId) async {
    bool subStatus =
        await SubscriptionDbService(widget.userId).checkUserSubscriptionStatus();
    if (subStatus == true) {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserData>(
        stream: SubscriptionDbService(widget.userId).featchUserDataFromDb,
  ...
  Future<void> verifyAndDeliverProduct(PurchaseDetails purchaseDetails) async {
    ...
    if (res.data) {
      //save purchase in db
      await SubscriptionDbService(widget.userId).saveSubcriptionsDetails(purchaseDetails);
